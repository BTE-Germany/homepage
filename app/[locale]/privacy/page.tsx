        ...
        <div className="container mx-auto">
            <div className="prose max-w-full! dark:prose-invert my-12 mt-32">
                ...
                <ul className="index">
                    ...
                    <li>
                        <a className="index-link" href="#m2555">
                    ...
                    <li>
                        <a className="index-link" href="#m135">
                ...
                <p>
                    Vertretungsberechtigte Personen: Robin Ferch, Leander Schöngarth und Malte
                    Hironimus
                </p>
                <p>E-Mail-Adresse: vorstand@bte-germany.de</p>
                ...
                <p>
                    ...
                    der Begriffe wird jedoch im Rahmen der Geltung des Schweizer DSG weiterhin
                ...
                <p>
                    ...
                    höchsten Sicherheitsstandards entsprechen. Wenn eine Website durch ein
                    SSL-/TLS-Zertifikat gesichert ist, wird dies durch die Anzeige von HTTPS in
                    der URL signalisiert. Dies dient als ein Indikator für die Nutzer, dass ihre
                ...
                <p>
                    ...
                    von Diensten und Inhalten, die in eine Website eingebunden sind. In solchen
                ...
                <p>
                    ...
                    jeweiligen Anbieters oder wenn in der Datenschutzerklärung ausdrücklich auf
                    den Datentransfer in Drittländer hingewiesen wird), erfolgt dies stets im
                ...
                <p>
                    ...
                    Änderungen im Rahmen des DPF ergeben, greifen die Standardvertragsklauseln
                    als zuverlässige Rückfalloption ein. So stellen wir sicher, dass Ihre Daten
                    auch bei etwaigen politischen oder rechtlichen Veränderungen stets
                    angemessen geschützt bleiben.
                </p>
                <p>
                    Bei den einzelnen Diensteanbietern informieren wir Sie darüber, ob sie nach
                    dem DPF zertifiziert sind und ob Standardvertragsklauseln vorliegen. Weitere
                    Informationen zum DPF und eine Liste der zertifizierten Unternehmen finden
                ...
                <p>
                    ...
                    Einwilligungen oder gesetzlich erforderliche Übermittlungen. Informationen
                    zu Drittlandtransfers und geltenden Angemessenheitsbeschlüssen können Sie
                    dem Informationsangebot der EU-Kommission entnehmen:{" "}
                    <a
                ...
                <p>
                    ...
                    Datums, ist stets die längste Frist maßgeblich. Daten, die nicht mehr für
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Organisationsunterlagen (§ 147 Abs. 1 Nr. 1 i.V.m. Abs. 3 AO, § 14b Abs. 1
                        UStG, § 257 Abs. 1 Nr. 1 i.V.m. Abs. 4 HGB).
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        und Kassenstreifen (§ 147 Abs. 1 Nr. 2, 3, 5 i.V.m. Abs. 3 AO, § 257 Abs.
                        1 Nr. 2 u. 3 i.V.m. Abs. 4 HGB).
                    </li>
                    <li>
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        Kontaktdaten (E-Mail-Adresse, Telefonnummer), Mitgliedsnummer,
                    ...
                    <li>
                        <strong>Betroffene Personen:</strong> Mitglieder; Interessenten.
                        Kommunikationspartner.
                    </li>
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Kommunikation; Organisations-
                        und Verwaltungsverfahren; Öffentlichkeitsarbeit und Informationszwecke.
                        Geschäftsprozesse und betriebswirtschaftliche Verfahren.
                    </li>
                    <li>
                        <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben
                    ...
                    <li className="">
                        ...
                        Abs. 1 S. 1 lit. b) DSGVO). Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1
                        lit. c) DSGVO).
                    </li>
                </ul>
                <p>
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Mitgliederverwaltung: </strong>Verfahren, die im Rahmen der
                        ...
                        mit den Mitgliedern. Diese Prozesse beinhalten die sorgfältige Erfassung
                        und Pflege von Mitgliederdaten, die regelmäßige Aktualisierung von
                        Mitgliedsinformationen und die Verwaltung von Mitgliedsbeiträgen
                        einschließlich der Rechnungsstellung und Abrechnung;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO), Vertrag über die Mitgliedschaft (Satzung) (Art. 6
                    ...
                    <li>
                        <strong>Beitragsverwaltung: </strong>Zu den für die Verwaltung der
                        Mitgliedsbeiträge erforderlichen Verarbeitungstätigkeiten gehören die
                        Erfassung der Mitgliedsbeitragsdaten nach dem Beitritt eines Mitglieds,
                        die Nachverfolgung von Mitgliedsbeitragszahlungen und die systematische
                        ...
                        Verbindlichkeiten sowie das Führen entsprechender Bücher und
                        Aufzeichnungen;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Rechtliche Verpflichtung (Art. 6 Abs.
                            1 S. 1 lit. c) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
                            f) DSGVO), Vertrag über die Mitgliedschaft (Satzung) (Art. 6 Abs. 1 S. 1
                            lit. b) DSGVO).
                        </span>
                    </li>
                    <li>
                        <strong>Veranstaltungen und Organisationsbetrieb: </strong>Planung,
                        ...
                        Aktualisierung der Teilnehmerinformationen während der Veranstaltung und
                        die Erfassung der Anwesenheit und Teilnehmeraktivitäten. Die Nachbereitung
                        ...
                        interner Meetings und Sitzungen;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO), Vertrag über die Mitgliedschaft (Satzung) (Art. 6
                            Abs. 1 S. 1 lit. b) DSGVO).
                    ...
                    <li>
                        <strong>Öffentlichkeitsarbeit: </strong>Verfahren umfassen die Erstellung
                        und Verbreitung von Informationsmaterialien, die Pflege von Kontaktdaten
                        für Presse und Medienbeziehungen sowie die Organisation und Durchführung
                        von Pressekonferenzen und öffentlichen Veranstaltungen. Die Erstellung von
                        ...
                        Planung und Durchführung dieser Ereignisse, das Einladungsmanagement und
                        die Koordination der Veranstaltungslogistik. Die Interaktion mit Medien
                        und Interessengruppen erfolgt durch direkte Kommunikation mit
                        Journalisten, Bloggern und anderen Meinungsführern, das Beantworten von
                        Anfragen und die Bereitstellung von Informationen;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO), Vertrag über die Mitgliedschaft (Satzung) (Art. 6
                            Abs. 1 S. 1 lit. b) DSGVO).
                    ...
                    <li>
                        <strong>VereinOnline: </strong>Organisationsmanagement-Software zur
                        Verwaltung von Mitgliedern und Kontakten, Terminen und Benachrichtigungen,
                        Finanzen, Beiträgen oder Spenden, Organisationsstrukturen und Listen sowie
                        zur Kommunikation und Zusammenarbeit; Rechtsgrundlagen: Vertragserfüllung
                        ...
                        <strong>Dienstanbieter:</strong> GRITH AG, Von-Poschinger-Str. 32, 85737
                        Ismaning; <strong>Website:</strong>{" "}
                        <a href="https://www.vereinonline.org" target="_blank">
                            https://www.vereinonline.org
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://www.vereinonline.org/datenschutz" target="_blank">
                            https://www.vereinonline.org/datenschutz
                        </a>
                        .
                    </li>
                </ul>
                ...
                <p>
                    ...
                    Gewährleistungs- und sonstigen Leistungsstörungen. Darüber hinaus verwenden
                    wir die Daten zur Wahrung unserer Rechte und zum Zwecke der mit diesen
                ...
                <p>
                    ...
                    sie aus gesetzlichen Gründen der Archivierung aufbewahrt werden müssen (etwa
                    für Steuerzwecke im Regelfall zehn Jahre). Daten, die uns im Rahmen eines
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        verbundener Leistungen, als auch deren Bezahlung und Bereitstellung, bzw.
                        Zustellung, oder Ausführung zu ermöglichen. Sofern für die Ausführung
                    ...
                    <li>
                        ...
                        Leistungen erbringen zu können. Zu den Verfahren, die im Rahmen und zu den
                        Zwecken des Consultings gehören, zählen: Kontaktaufnahme und Kommunikation
                        mit den Klienten, Durchführung von Bedarfs- und Anforderungsanalysen,
                        Planung und Implementierung von Beratungsprojekten, Dokumentation der
                        ...
                        wie z.&nbsp;B. Behörden, Subunternehmer oder im Bereich der IT, der Büro-
                    ...
                    <li>
                        <strong>IT-Dienstleistungen: </strong>Wir verarbeiten die Daten unserer
                        Kunden sowie Auftraggeber, um ihnen die Planung, Implementierung sowie den
                        Support von IT-Lösungen und damit verbundenen Dienstleistungen zu
                        ermöglichen. Die erforderlichen Angaben sind als solche im Rahmen des
                        Auftrags-, Projekt- bzw. vergleichbaren Vertragsschlusses gekennzeichnet
                        ...
                        beinhaltet das Erstellen und Verwalten von Projektzeitplänen, Budgets
                        sowie Ressourcenallokationen. Die Datenverarbeitung unterstützt auch das
                        ...
                        <br />
                        <br />
                        Ein weiterer Prozess ist das Kundenbeziehungsmanagement (CRM), welches die
                        Aufzeichnung und Analyse von Kundeninteraktionen und -feedback beinhaltet,
                        um die Dienstleistungsqualität zu verbessern und individuelle
                        Kundenbedürfnisse effizient zu adressieren. Zusätzlich umfasst der
                        Verarbeitungsprozess die technische Unterstützung und das
                        ...
                        All diese Prozesse sind darauf ausgerichtet, eine hohe Kundenzufriedenheit
                        und die Einhaltung aller relevanten Vorgaben zu gewährleisten;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche
                            Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Rechtliche Verpflichtung
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        <strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber;
                        Geschäfts- und Vertragspartner. Nutzer (z.&nbsp;B. Webseitenbesucher,
                        Nutzer von Onlinediensten).
                    </li>
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher
                        Leistungen und Erfüllung vertraglicher Pflichten; Marketing;
                        Geschäftsprozesse und betriebswirtschaftliche Verfahren. Bereitstellung
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Displate: </strong>Onlineshop, Paymentlösungen und Fulfillment, zu
                        deren Durchführung Cookies eingesetzt und die IP-Adresse, Datum, Uhrzeit
                        und weitere technische Daten über den verwendeten Internetbrowser, das
                        Betriebssystem sowie Bestands-, Vertrags- und Zahlungsdaten der Nutzer
                        verarbeitet werden; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs.
                        1 S. 1 lit. f) DSGVO); <strong>Dienstanbieter:</strong> GWD Concept Sp. z
                        o.o., Warschau (02-017) Aleje Jerozolimskie 123a, Republik Polen;{" "}
                        <strong>Website:</strong>{" "}
                        <a href="https://displate.com" target="_blank">
                            https://displate.com
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://displate.com/about-privacy" target="_blank">
                            https://displate.com/about-privacy
                        </a>
                        .
                    </li>
                    <li>
                        <strong>Fourthwall: </strong>Onlineshop, Paymentlösungen und Fulfillment,
                        zu deren Durchführung Cookies eingesetzt und die IP-Adresse, Datum,
                        Uhrzeit und weitere technische Daten über den verwendeten Internetbrowser,
                        das Betriebssystem sowie Bestands-, Vertrags- und Zahlungsdaten der Nutzer
                        verarbeitet werden; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs.
                        1 S. 1 lit. f) DSGVO); <strong>Dienstanbieter:</strong> Fourthwall, Inc.,
                        PO Box 5696, Santa Monica, CA 90405, Vereinigte Staaten von Amerika;{" "}
                        <strong>Website:</strong>{" "}
                        <a href="https://fourthwall.com/" target="_blank">
                            https://fourthwall.com/
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://fourthwall.com/privacy-policy" target="_blank">
                            https://fourthwall.com/privacy-policy
                        </a>
                        .
                    </li>
                    <li>
                        <strong>Patreon: </strong>Internetplattform zur Projektfinanzierung über
                        Crowdfunding sowie den Verkauf von Abonnements und Mitgliedschaften, die
                        Abrechnung sowie die Bereitstellung von Zugangs- und Bezahlverfahren, zu
                        deren Durchführung Cookies eingesetzt und die IP-Adresse, Datum, Uhrzeit
                        und weitere technische Daten über den verwendeten Internetbrowser, das
                        Betriebssystem sowie Bestands-, Vertrags- und Zahlungsdaten der Nutzer
                        verarbeitet werden; <strong>Dienstanbieter:</strong> Patreon Irland
                        Limited, German Branch Revaler Strasse 99, Hall 20, 2nd floor Rooms 3.19
                        and 3.25. 10245 Berlin-Friedrichshain, Deutschland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                        </span>
                        <strong>Website:</strong>{" "}
                        <a href="https://www.patreon.com/de-DE" target="_blank">
                            https://www.patreon.com/de-DE
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://privacy.patreon.com/policies" target="_blank">
                ...
                <p>
                    ...
                    weitere Dienstleister ein (zusammenfassend "Zahlungsdienstleister"). Der
                    Zahlungsverkehr erfolgt dabei entsprechend dem Stand der Technik
                    ausschließlich über verschlüsselte Verbindungen, sodass die eingegebenen
                    Daten während der Übermittlung vor unbefugtem Zugriff geschützt sind.
                </p>
                <p>
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        Betriebssysteme, Interaktionen mit Inhalten und Funktionen); Meta-,
                        Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben,
                        Identifikationsnummern, beteiligte Personen). Kontaktdaten (z.&nbsp;B.
                    ...
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher
                        Leistungen und Erfüllung vertraglicher Pflichten. Geschäftsprozesse und
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        B. Angaben zur Autorenschaft oder Zeitpunkt der Erstellung). Kontaktdaten
                    ...
                    <li>
                        ...
                        Vertragspartner; Kommunikationspartner. Dritte Personen.
                    </li>
                    <li>
                        ...
                        Content Delivery Network (CDN); Kommunikation; Organisations- und
                        Verwaltungsverfahren. Künstliche Intelligenz (KI).
                    </li>
                    <li>
                        <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben
                        im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        <strong>Dienstanbieter:</strong> 1&amp;1 IONOS SE, Elgendorfer Str. 57,
                        56410 Montabaur, Deutschland; <strong>Website:</strong>{" "}
                    ...
                    <li>
                        <strong>Gmail: </strong>E-Mail-Versand und -Empfang, Speicherung von
                        Kontakten im Adressbuch, Filterregeln zur Sortierung eingehender E-Mails,
                        Spam- und Virenschutz, Cloud-Speicher für Anhänge und andere Inhalte;{" "}
                    ...
                    <li>
                        ...
                        <a href="https://cloud.google.com/privacy" target="_blank">
                    ...
                    <li>
                        ...
                        <strong>Website:</strong>{" "}
                        <a href="https://aws.amazon.com/de/cloudfront/" target="_blank">
                    ...
                    <li>
                        <strong>Vercel: </strong>Leistungen auf dem Gebiet der Bereitstellung von
                        informationstechnischer Infrastruktur und verbundenen Dienstleistungen
                        (z.&nbsp;B. Speicherplatz und/oder Rechenkapazitäten) sowie
                        Entwicklungsumgebung; <strong>Dienstanbieter:</strong> Vercel Inc., 340 S
                    ...
                    <li>
                        <strong>Microsoft Azure OpenAI Service: </strong>Interface-Zugriff
                        (sogenannte "API") auf KI-basierte Dienste, die darauf ausgelegt sind,
                        natürliche Sprache und zugehörige Eingaben zu verstehen und zu generieren,
                        Informationen zu analysieren und Vorhersagen zu treffen ("KI", d. h.
                        "Künstliche Intelligenz", ist im jeweils anwendbaren rechtlichen Sinne des
                        Begriffs zu verstehen). Das Erbringen der KI-Dienste umfasst die
                        Verarbeitung (einschließlich Sammlung, Speicherung, Organisation und
                        Strukturierung) von personenbezogenen Daten als Teil eines auf natürlicher
                        Sprache basierenden, maschinellen Lernverfahrens; die Durchführung von
                        Aktivitäten zur Überprüfung oder Aufrechterhaltung der Qualität der
                        Dienste; die Identifizierung und Behebung von Fehlern, die die bestehende
                        beabsichtigte Funktionalität beeinträchtigen, sowie die Unterstützung zur
                        Gewährleistung der Sicherheit und Integrität der KI-Dienste;{" "}
                        <strong>Dienstanbieter:</strong> Microsoft Irland Operations Limited, One
                        Microsoft Place, South County Business Park, Leopardstown, Dublin 18, D18
                        P521, Irland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                        ...
                        <strong>Website:</strong>{" "}
                        <a
                            href="https://azure.microsoft.com/de-de/products/ai-foundry/models/openai/"
                            target="_blank"
                        >
                        ...
                        ; <strong>Auftragsverarbeitungsvertrag:</strong>{" "}
                        <a
                            href="https://azure.microsoft.com/de-de/support/legal/"
                            target="_blank"
                        >
                    ...
                    <li>
                        <strong>Tuxis B.V.: </strong>Backup-Software und Backup-Speicherung;
                        Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
                        DSGVO); Die Daten werden ausschließlich verschlüsselt gespeichert und
                        können durch Backblaze nicht gelesen werden;{" "}
                        <strong>Dienstanbieter:</strong> Tuxis B.V.
                        <br />
                        Darwinstraat 29D
                        <br />
                        6718 XR, Ede
                        <br />
                        Niederlande; <strong>Website:</strong>{" "}
                        <a href="https://www.tuxis.nl/" target="_blank">
                            https://www.tuxis.nl/
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://www.tuxis.nl/en/privacy-policy/" target="_blank">
                            https://www.tuxis.nl/en/privacy-policy/
                        </a>
                        .
                    </li>
                    <li>
                        <strong>Wasabi Technologies LLC: </strong>Backup-Software und
                        Backup-Speicherung; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs.
                        1 S. 1 lit. f) DSGVO); Die Daten werden ausschließlich verschlüsselt
                        gespeichert und können durch Backblaze nicht gelesen werden.
                        Auftragsverarbeitungsvertrag:
                        https://wasabi.com/legal/data-processing-agreement;{" "}
                        <strong>Dienstanbieter:</strong> Wasabi Technologies LLC
                        <br />
                        ...
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://wasabi.com/legal/privacy-policy" target="_blank">
                            https://wasabi.com/legal/privacy-policy
                        </a>
                        .
                    </li>
                    <li>
                        <strong>Aternos GmbH: </strong>Leistungen auf dem Gebiet der
                        Bereitstellung von informationstechnischer Infrastruktur und verbundenen
                        Dienstleistungen (z.&nbsp;B. Speicherplatz und/oder Rechenkapazitäten);
                        Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
                        DSGVO); <strong>Dienstanbieter:</strong> Aternos GmbH
                        <br />
                        Konrad-Adenauer-Platz 28
                        <br />
                        53225 Bonn; <strong>Website:</strong>{" "}
                        <a href="https://aternos.gmbh" target="_blank">
                            https://aternos.gmbh
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://aternos.gmbh/de/aternos/privacy" target="_blank">
                            https://aternos.gmbh/de/aternos/privacy
                        </a>
                        .
                    </li>
                    <li>
                        <strong>Sentry (Selfhosted): </strong>Überwachung der Systemstabilität und
                        Ermittlung von Codefehlern - Angaben zum Gerät oder Fehlerzeitpunkt werden
                        pseudonym erhoben und werden anschließend gelöscht; Rechtsgrundlagen:
                        Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                        <br />
                        Die Daten werden auf unseren eigenen Servern erhoben und verarbeitet.
                    </li>
                    <li>
                        <strong>
                    ...
                    <li>
                        <strong>Amazon Web Services (AWS): </strong>Leistungen auf dem Gebiet der
                        Bereitstellung von informationstechnischer Infrastruktur und verbundenen
                        Dienstleistungen (z.&nbsp;B. Speicherplatz und/oder Rechenkapazitäten);{" "}
                        <strong>Dienstanbieter:</strong> Amazon Web Services EMEA SARL, 38 avenue
                    ...
                    <li>
                        <strong>Cloudflare: </strong>Content-Delivery-Network (CDN) - Dienst, mit
                        ...
                        (DPF), Standardvertragsklauseln (
                        <a
                            href="https://www.cloudflare.com/cloudflare-customer-scc/"
                            target="_blank"
                        >
                    ...
                    <li>
                        <strong>Google Gemini API: </strong>Interface-Zugriff (sogenannte "API")
                        auf KI-basierte Dienste, die darauf ausgelegt sind, natürliche Sprache und
                        zugehörige Eingaben zu verstehen und zu generieren, Informationen zu
                        analysieren und Vorhersagen zu treffen ("KI", d. h. "Künstliche
                        Intelligenz", ist im jeweils anwendbaren rechtlichen Sinne des Begriffs zu
                        verstehen). Das Erbringen der KI-Dienste umfasst die Verarbeitung
                        (einschließlich Sammlung, Speicherung, Organisation und Strukturierung)
                        von personenbezogenen Daten als Teil eines auf natürlicher Sprache
                        basierenden, maschinellen Lernverfahrens; die Durchführung von Aktivitäten
                        zur Überprüfung oder Aufrechterhaltung der Qualität der Dienste; die
                        Identifizierung und Behebung von Fehlern, die die bestehende beabsichtigte
                        Funktionalität beeinträchtigen, sowie die Unterstützung zur Gewährleistung
                        der Sicherheit und Integrität der KI-Dienste;{" "}
                        <strong>Dienstanbieter:</strong> Google Cloud EMEA Limited, 70 Sir John
                        Rogerson’s Quay, Dublin 2, Irland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                        ...
                        <strong>Website:</strong> Google Cloud EMEA Limited, 70 Sir John
                        Rogerson’s Quay, Dublin 2, Irland; <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://cloud.google.com/" target="_blank">
                            https://cloud.google.com/
                        </a>
                        ; <strong>Auftragsverarbeitungsvertrag:</strong>{" "}
                        <a
                            href="https://business.safety.google/processorterms/?hl=de"
                            target="_blank"
                        >
                ...
                <p>
                    ...
                    Endgeräten der Nutzer speichern und aus ihnen auslesen, verstanden. Cookies
                    können ferner in Bezug auf unterschiedliche Anliegen Einsatz finden, etwa zu
                    Zwecken der Funktionsfähigkeit, der Sicherheit und des Komforts von
                    Onlineangeboten sowie der Erstellung von Analysen der Besucherströme. Wir
                    verwenden Cookies gemäß den gesetzlichen Vorschriften. Dazu holen wir, wenn
                    erforderlich, vorab die Zustimmung der Nutzer ein. Ist eine Zustimmung nicht
                    notwendig, setzen wir auf unsere berechtigten Interessen. Dies gilt, wenn
                    das Speichern und Auslesen von Informationen unerlässlich ist, um
                    ausdrücklich angeforderte Inhalte und Funktionen bereitstellen zu können.
                    Dazu zählen etwa die Speicherung von Einstellungen sowie die Sicherstellung
                    der Funktionalität und Sicherheit unseres Onlineangebots. Die Einwilligung
                    kann jederzeit widerrufen werden. Wir informieren klar über deren Umfang und
                ...
                <ul>
                    ...
                    <li>
                        ...
                        von Cookies erhobenen Nutzerdaten zur Reichweitenmessung Verwendung
                        finden. Sofern wir Nutzern keine expliziten Angaben zur Art und
                        Speicherdauer von Cookies mitteilen (z.&nbsp;B. im Rahmen der Einholung
                        der Einwilligung), sollten sie davon ausgehen, dass diese permanent sind
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        und das verwendete Endgerät gespeichert wird;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit.
                            a) DSGVO).
                        </span>
                    ...
                    <li>
                        <strong>Cookiebot: </strong>Speicherung und Verwaltung von Einwilligungen
                        ...
                        Nutzer; <strong>Dienstanbieter:</strong> Usercentrics A/S, Havnegade 39,
                        1058 Kopenhagen, Dänemark; <strong>Website:</strong>{" "}
                        <a href="https://www.cookiebot.com/de" target="_blank">
                        ...
                        bereitgestellt; <strong>Weitere Informationen:</strong> Gespeicherte Daten
                        (auf dem Server des Dienstleisters): Die IP-Nummer des Nutzers in
                        anonymisierter Form (die letzten drei Ziffern werden auf 0 gesetzt), Datum
                        und Uhrzeit der Zustimmung, Browserangaben, die URL, von der die
                        Zustimmung gesendet wurde, Ein anonymer, zufälliger und verschlüsselter
                        Schlüsselwert. der Einwilligungsstatus des Nutzers.
                    </li>
                </ul>
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Discord Single-Sign-On: </strong>Authentifizierungsdienste für
                        Nutzeranmeldungen, Bereitstellung von Single Sign-On-Funktionen,
                        Verwaltung von Identitätsinformationen und Anwendungsintegrationen;
                        Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
                        DSGVO); <strong>Dienstanbieter:</strong> Discord, Inc., 444 De Haro St,
                        Suite 200, San Francisco, California 94107, USA; <strong>Website:</strong>{" "}
                    ...
                    <li>
                        <strong>Apple Single-Sign-On: </strong>Authentifizierungsdienste für
                        Nutzeranmeldungen, Bereitstellung von Single Sign-On-Funktionen,
                        Verwaltung von Identitätsinformationen und Anwendungsintegrationen;{" "}
                    ...
                    <li>
                        ...
                        ; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework
                        (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Einstellungen
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Discord: </strong>Chat, Audio- und Videoübertragungen, Instant
                        Messaging und Community-Management; <strong>Dienstanbieter:</strong>{" "}
                        Discord, Inc., 444 De Haro St, Suite 200, San Francisco, California 94107,
                        USA;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                ...
                <p>
                    ...
                    der Nachrichten nicht einsehbar ist, nicht einmal durch die
                ...
                <p>
                    ...
                    Beziehungen, im Kontext von Archivierungsvorgaben etc.) und sonst, sobald
                    wir davon ausgehen können, etwaige Auskünfte der Kommunikationspartner
                ...
                <p>
                    <strong>Vorbehalt des Verweises auf andere Kommunikationswege:</strong> Um
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Instagram: </strong>Nachrichtenversand über das soziale Netzwerk
                        Instagram; <strong>Dienstanbieter:</strong> Meta Platforms Ireland
                ...
                <h2 id="m2555">Künstliche Intelligenz (KI)</h2>
                <p>
                    Wir setzen Künstliche Intelligenz (KI) ein, wobei personenbezogene Daten
                    verarbeitet werden. Die spezifischen Zwecke und unser Interesse am Einsatz
                    der KI werden nachfolgend genannt. Unter KI verstehen wir entsprechend dem
                    Begriff eines "KI-Systems" gemäß Artikel 3 Nr. 1 der KI-Verordnung ein
                    maschinengestütztes System, das für einen in wechselndem Maße autonomen
                    Betrieb ausgelegt ist, nach seiner Einführung anpassungsfähig sein kann und
                    aus den erhaltenen Eingaben Ergebnisse wie Vorhersagen, Inhalte,
                    Empfehlungen oder Entscheidungen hervorbringt, die physische oder virtuelle
                    Umgebungen beeinflussen können.
                </p>
                <p>
                    Unsere KI-Systeme werden unter strikter Beachtung der gesetzlichen Vorgaben
                    eingesetzt. Diese umfassen sowohl spezifische Regelungen für Künstliche
                    Intelligenz als auch Datenschutzvorgaben. Dabei halten wir insbesondere die
                    Prinzipien der Rechtmäßigkeit, Transparenz, Fairness, menschlichen
                    Kontrolle, Zweckbindung, Datenminimierung und Integrität sowie
                    ...
                    kann entweder die Einwilligung der betroffenen Personen oder eine
                    gesetzliche Erlaubnis sein.
                </p>
                <p>
                    Bei der Nutzung externer KI-Systeme wählen wir deren Anbieter (nachfolgend
                    "KI-Anbieter") sorgfältig aus. Entsprechend unseren gesetzlichen Pflichten
                    stellen wir sicher, dass die KI-Anbieter die geltenden Bestimmungen
                    einhalten. Ebenso beachten wir die uns obliegenden Pflichten bei Nutzung
                    oder Betrieb der bezogenen KI-Leistungen. Die Verarbeitung personenbezogener
                    Daten durch uns und die KI-Anbieter erfolgt ausschließlich auf Grundlage
                    einer Einwilligung oder gesetzlichen Berechtigung. Dabei legen wir
                    besonderen Wert auf Transparenz, Fairness und die Wahrung der menschlichen
                    Kontrolle über KI-gestützte Entscheidungsprozesse.
                </p>
                <p>
                    Zum Schutz der verarbeiteten Daten implementieren wir angemessene und
                    robuste technische sowie organisatorische Maßnahmen. Diese gewährleisten die
                    Integrität und Vertraulichkeit der verarbeiteten Daten und minimieren
                    potenzielle Risiken. Durch regelmäßige Überprüfungen der KI-Anbieter und
                    ihrer Leistungen stellen wir die fortlaufende Einhaltung aktueller
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Künstliche Intelligenz (KI).
                    </li>
                    <li>
                        <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben
                        im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        <strong>OpenAI API: </strong>Eine API (Programmierschnittstelle) für
                        Künstliche Intelligenz, die Entwicklern Zugriff auf Sprach- und
                        Bildmodelle wie GPT und DALL·E bietet. Sie ermöglicht die Integration von
                        Funktionen wie automatischer Textgenerierung, Verarbeitung natürlicher
                        Sprache (NLP), Übersetzung, Codeerstellung, Bilderzeugung und Bildanalyse
                        in eigene Anwendungen. Über standardisierte Schnittstellen lassen sich
                        komplexe KI-Funktionen einbinden und Prozesse automatisieren;{" "}
                        <strong>Dienstanbieter:</strong> OpenAI Ireland Ltd, 117-126 Sheriff
                        Street Upper, D01 YC43 Dublin 1, Irland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                        </span>
                        ...
                        ; <strong>Datenschutzerklärung:</strong>{" "}
                        <a
                            href="https://openai.com/de/policies/eu-privacy-policy"
                            target="_blank"
                        >
                        ...
                        <a
                            href="https://privacy.openai.com/policies?modal=select-subject"
                            target="_blank"
                        >
                ...
                <p>
                    ...
                    konkreten Konferenz gefordert werden (z.&nbsp;B. Angabe von Zugangsdaten
                    oder Klarnamen) und welche optionalen Angaben durch die Teilnehmer getätigt
                ...
                <p>
                    ...
                    Audioaufnahmen protokolliert werden, wird dies den Teilnehmern im Vorwege
                ...
                <p>
                    ...
                    Aufnahme (z.&nbsp;B. durch Hinweise an Mitbewohner, Abschließen von Türen
                    und Nutzung, soweit technisch möglich, der Funktion zur Unkenntlichmachung
                ...
                <p>
                    ...
                    bestimmter Funktionen bitten (z.&nbsp;B. Einverständnis mit einer
                    Aufzeichnung von Konferenzen), ist die Rechtsgrundlage der Verarbeitung
                    diese Einwilligung. Ferner kann unsere Verarbeitung zur Erfüllung unserer
                    vertraglichen Pflichten erforderlich sein (z.&nbsp;B. in Teilnehmerlisten,
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        ...
                        Kommunikationssoftware; <strong>Dienstanbieter:</strong> Google Ireland
                    ...
                    <li>
                        <strong>Twitch: </strong>Chats und Live-Streams;{" "}
                        <strong>Dienstanbieter:</strong> Twitch Interactive, Inc., 350 Bush
                        Street, 2nd Floor, San Francisco, CA 94104, USA;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                        </span>
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        ...
                        Kommunikationspartner; Geschäfts- und Vertragspartner. Nutzer (z.&nbsp;B.
                        Webseitenbesucher, Nutzer von Onlinediensten).
                    </li>
                    <li>
                ...
                <p>
                    ...
                    werden, sind diese Inhalte für die Einwilligung der Nutzer maßgeblich. Für
                    die Anmeldung zu unserem Newsletter ist normalerweise die Angabe Ihrer
                    E-Mail-Adresse ausreichend. Um Ihnen jedoch einen personalisierten Service
                    bieten zu können, bitten wir gegebenenfalls um die Angabe Ihres Namens für
                    eine persönliche Ansprache im Newsletter oder um weitere Informationen,
                ...
                <p>
                    ...
                    Einwilligung nachweisen zu können. Die Verarbeitung dieser Daten wird auf
                    den Zweck einer potenziellen Abwehr von Ansprüchen beschränkt. Ein
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        Zeitangaben, Identifikationsnummern, beteiligte Personen). Nutzungsdaten
                ...
                <ul className="m-elements">
                    <li>
                        ...
                        enthalten einen sogenannten „Web Beacons", d. h. eine pixelgroße Datei,
                        die beim Öffnen des Newsletters von unserem bzw. dessen Server, sofern wir
                        einen Versanddienstleister einsetzen, abgerufen wird. Im Rahmen dieses
                        Abrufs werden zunächst sowohl technische Informationen, wie beispielsweise
                        ...
                        mithilfe der IP-Adresse bestimmbar sind) oder der Zugriffszeiten genutzt.
                        Diese Analyse beinhaltet ebenfalls die Feststellung, ob und wann die
                        Newsletter geöffnet und welche Links angeklickt werden. Die Informationen
                        werden den einzelnen Newsletterempfängern zugeordnet und in deren Profilen
                        bis zur Löschung gespeichert. Die Auswertungen dienen dazu, die
                        ...
                        sowie die Speicherung der Messergebnisse in den Profilen der Nutzer sowie
                        ihre weitere Verarbeitung erfolgen auf Grundlage einer Einwilligung der
                        Nutzer. Ein getrennter Widerruf der Erfolgsmessung ist leider nicht
                        möglich, in diesem Fall muss das gesamte Newsletterabonnement gekündigt
                        bzw. ihm widersprochen werden. In dem Fall werden die gespeicherten
                    ...
                    <li>
                        <strong>Mailjet: </strong>E-Mail-Versand- und E-Mail-Versand- und
                        Automatisierungsdienste; <strong>Dienstanbieter:</strong> Mailjet
                        ...
                        <strong>Website:</strong>{" "}
                        <a href="https://www.mailjet.de" target="_blank">
                            https://www.mailjet.de
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://www.mailjet.de/privacy-policy" target="_blank">
                ...
                <p>
                    ...
                    Umfrage im Browser des Nutzers darzustellen oder mithilfe eines Cookies eine
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        ...
                        Feedback via Online-Formular). Umfragen und Fragebögen (z.&nbsp;B.
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Formbricks: </strong>Erstellung und Auswertung von
                        Onineformularen, Umfragen, Feedbackbögen, etc; Rechtsgrundlagen:
                        Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO). Die
                        Datenverarbeitung und Erhebung erfolgt ausschließlich auf unseren Servern.
                    </li>
                    <li>
                ...
                <p>
                    Darüber hinaus werden die IP-Adressen der Nutzer gespeichert. Jedoch nutzen
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        ...
                        nutzerbezogenen Informationen (Erstellen von Nutzerprofilen). Remarketing.
                    </li>
                    <li>
                        <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben
                        im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".
                        Speicherung von Cookies von bis zu 2 Jahren (Sofern nicht anders
                        angegeben, können Cookies und ähnliche Speichermethoden für einen Zeitraum
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        <strong>umami: </strong>Webanalyse, Reichweitenmessung und Analyse des
                        Nutzerverhaltens; erfolgt pseudonymisiert und ohne die Bildung von
                        Nutzerprofilen; alle Nutzerdaten werden anonymisiert gespeichert, das
                        heißt, ohne personenbezogene Daten und ohne Einsatz von Cookies oder
                        vergleichbaren persistenten Onlinekennzeichen;{" "}
                        <strong>Dienstanbieter:</strong> Ausführung auf Servern und/oder Computern
                ...
                <p>
                    ...
                    Affiliate-Links folgen, bzw. anschließend die Angebote wahrnehmen, können
                    wir von diesen Drittanbietern eine Provision oder sonstige Vorteile erhalten
                ...
                <p>
                    ...
                    der Zeitpunkt, eine Online-Kennung der Betreiber der Webseite, auf der sich
                    der Affiliate-Link befand, eine Online-Kennung des jeweiligen Angebotes, die
                    Art des verwendeten Links, die Art des Angebotes und eine Online-Kennung des
                    Nutzers gehören.
                </p>
                <p>
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        <strong>Betroffene Personen:</strong> Interessenten. Nutzer (z.&nbsp;B.
                        Webseitenbesucher, Nutzer von Onlinediensten).
                    </li>
                    <li>
                        <strong>Zwecke der Verarbeitung:</strong> Affiliate-Nachverfolgung.
                    </li>
                    <li>
                        <strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben
                        im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".
                ...
                <ul className="m-elements">
                    <li>
                        <strong>zave.it: </strong>Affiliate-Partnerprogramm; Rechtsgrundlagen:
                        Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO);{" "}
                        <strong>Dienstanbieter:</strong> Planic GmbH, Weintraubengasse 2, 90403
                        Nürnberg; <strong>Website:</strong>{" "}
                        <a href="https://zave.it" target="_blank">
                            https://zave.it
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://zave.it/de-de/datenschutz" target="_blank">
                            https://zave.it/de-de/datenschutz
                        </a>
                        .
                    </li>
                </ul>
                ...
                <p>
                    ...
                    in diesem Rahmen Nutzerdaten, um mit den dort aktiven Nutzern zu
                ...
                <p>
                    ...
                    Nutzer Risiken ergeben, weil so zum Beispiel die Durchsetzung der
                    Nutzerrechte erschwert werden könnte.
                </p>
                <p>
                    Ferner werden die Daten der Nutzer innerhalb sozialer Netzwerke im Regelfall
                    für Marktforschungs- und Werbezwecke verarbeitet. So können beispielsweise
                    anhand des Nutzungsverhaltens und sich daraus ergebender Interessen der
                    Nutzer Nutzungsprofile erstellt werden. Letztere finden möglicherweise
                    wiederum Verwendung, um etwa Werbeanzeigen innerhalb und außerhalb der
                    Netzwerke zu schalten, die mutmaßlich den Interessen der Nutzer entsprechen.
                    Daher werden im Regelfall Cookies auf den Rechnern der Nutzer gespeichert,
                    in denen das Nutzungsverhalten und die Interessen der Nutzer gespeichert
                    werden. Zudem können in den Nutzungsprofilen auch Daten unabhängig der von
                    den Nutzern verwendeten Geräten gespeichert werden (insbesondere, wenn sie
                ...
                <p>
                    ...
                    Anbietern geltend gemacht werden können. Nur Letztere haben jeweils Zugriff
                    auf die Nutzerdaten und können direkt entsprechende Maßnahmen ergreifen und
                    Auskünfte geben. Sollten Sie dennoch Hilfe benötigen, dann können Sie sich
                    an uns wenden.
                </p>
                <ul className="m-elements">
                    <li>
                    ...
                    <li>
                        ...
                        Öffentlichkeitsarbeit; Bereitstellung unseres Onlineangebotes und
                ...
                <ul className="m-elements">
                    <li>
                        <strong>Linktree: </strong>Hosting einer Linksammlung für
                        Social-Media-Kanäle; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs.
                        1 S. 1 lit. f) DSGVO); <strong>Dienstanbieter:</strong> Linktree Pty Ltd,
                        1-9 Sackville Street, Collingwood VIC 3066, Australien;{" "}
                        <strong>Website:</strong>{" "}
                        <a href="https://linktr.ee" target="_blank">
                            https://linktr.ee
                        </a>
                        . <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://linktr.ee/s/privacy" target="_blank">
                    ...
                    <li>
                        ...
                        Ireland Limited verantwortlich; <strong>Dienstanbieter:</strong> Meta
                    ...
                    <li>
                        <strong>Threads: </strong>Soziales Netzwerk;{" "}
                        <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, Merrion
                        Road, Dublin 4, D04 X2K5, Irland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                    ...
                    <li>
                        <strong>TikTok: </strong>Soziales Netzwerk, ermöglicht das Teilen von
                        Fotos und Videos, das Kommentieren und Favorisieren von Beiträgen,
                    ...
                    <li>
                        <strong>X: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> X
                        Internet Unlimited Company, One Cumberland Place, Fenian Street, Dublin 2
                        D02 AX07, Irland;{" "}
                        <span className="">
                            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1
                            S. 1 lit. f) DSGVO);{" "}
                    ...
                    <li>
                        ...
                        ; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework
                        (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong>{" "}
                        <a
                ...
                <p>
                    ...
                    IP-Adresse der Nutzer verarbeiten, da sie ohne IP-Adresse die Inhalte nicht
                    ...
                    können darüber hinaus in Cookies auf dem Gerät der Nutzer gespeichert werden
                    und unter anderem technische Auskünfte zum Browser und zum Betriebssystem,
                    zu verweisenden Websites, zur Besuchszeit sowie weitere Angaben zur Nutzung
                ...
                <ul className="m-elements">
                    <li>
                        <strong>OpenStreetMap: </strong>Wir binden die Landkarten des Dienstes
                        "OpenStreetMap" ein, die auf Grundlage der Open Data Commons Open Database
                        Lizenz (ODbL) durch die OpenStreetMap Foundation (OSMF) angeboten werden.
                        Die Daten der Nutzer werden durch OpenStreetMap ausschließlich zu Zwecken
                        ...
                        Endgeräte oder Browser vollzogen) erhoben werden; Rechtsgrundlagen:
                        Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO);{" "}
                        <strong>Dienstanbieter:</strong> OpenStreetMap Foundation (OSMF), St
                        John’s Innovation Centre, Cowley Road, Cambridge, CB4 0WS, Vereinigtes
                        Königreich; <strong>Website:</strong>{" "}
                    ...
                    <li>
                        <strong>YouTube-Videos: </strong>Innerhalb unseres Onlineangebotes sind
                        Videos eingebettet, die bei YouTube gespeichert sind. Die Integration
                        dieser YouTube-Videos erfolgt über eine spezielle Domain mithilfe der
                        Komponente „youtube-nocookie" im sogenannten „erweiterten
                        Datenschutzmodus". Im „erweiterten Datenschutzmodus" können bis zum Start
                        des Videos lediglich Informationen, zu denen Ihre IP-Adresse sowie Angaben
                        zum Browser und Ihrem Endgerät gehören, auf Ihrem Endgerät in Cookies oder
                    ...
                    <li>
                        <strong>Mapbox: </strong>Bereitstellung und Bearbeitung von geografischen
                        und anderen Karten, Plänen und standortbezogenen Informationen;{" "}
                        <strong>Dienstanbieter:</strong> Mapbox, Inc., 740 15th St Nw Suite 500
                        ...
                        ; <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://www.mapbox.com/legal/privacy" target="_blank">
                            https://www.mapbox.com/legal/privacy
                        </a>
                        ; <strong>Auftragsverarbeitungsvertrag:</strong> Wird vom Dienstanbieter
                        bereitgestellt. <strong>Grundlage Drittlandtransfers:</strong> Data
                        Privacy Framework (DPF), Standardvertragsklauseln (Werden vom
                ...
                <p>
                    ...
                    der Drittanbieter und ihrer Leistungen beachten wir die gesetzlichen
                    Vorgaben.{" "}
                </p>
                <p>
                    In diesem Rahmen können personenbezogenen Daten verarbeitet und auf den
                ...
                <ul className="m-elements">
                    ...
                    <li>
                        ...
                        Vertragspartner; Leistungsempfänger und Auftraggeber. Beschäftigte
                ...
                <ul className="m-elements">
                    <li>
                        <strong>DocuSign: </strong>Elektronische Signatur von Dokumenten, Senden
                        von Dokumenten zur Unterschrift, Verfolgung des Status von Dokumenten,
                        Speicherung signierter Dokumente; <strong>Dienstanbieter:</strong>{" "}
                        ...
                        ; <strong>Datenschutzerklärung:</strong>{" "}
                        <a href="https://www.docusign.com/privacy" target="_blank">
                            https://www.docusign.com/privacy
                        </a>
                        ; <strong>Auftragsverarbeitungsvertrag:</strong>{" "}
                        <a
                            href="https://www.docusign.com/legal/terms-and-conditions/data-protection-attachment"
                            target="_blank"
                        >
                        ...
                        ). <strong>Weitere Informationen:</strong> Die Verarbeitung als
                        Auftragsverarbeiter und Verantwortlicher erfolgt ferner auf Grundlage von
                        genehmigten verbindlichen internen Datenschutzvorschriften, die ein den
                        Anforderungen der DSGVO entsprechendes Datenschutzniveau sicherstellen
                        (englisch: "Binding Corporate Rules", Art. 47 DSGVO):{" "}
                        <a
                            href="https://www.docusign.com/trust/privacy/binding-corporate-rules"
                            target="_blank"
                        >
                    ...
                    <li>
                        <strong>KI-Software (auf eigenem Server): </strong>Einsatz von
                        "Künstlicher Intelligenz" im jeweils geltenden rechtlichen Sinne des
                        Begriffs, d.&nbsp;h. vor allem auf bestimmter Logik und im wesentlichen
                        autonom natürliche Sprache oder sonstige Eingaben sowie Daten zu verstehen
                        und zu generieren, Informationen zu analysieren und Vorhersagen zu treffen
                        basierende Software; <strong>Dienstanbieter:</strong> Ausführung auf
                    ...
                    <li>
                        <strong>monday.com: </strong>Projektmanagement - Organisation und
                        Verwaltung von Teams, Gruppen, Arbeitsabläufen, Projekten und Prozessen;{" "}
                        <strong>Dienstanbieter:</strong> monday.com ltd, 6 Yitzhak Sadeh Street,
                        ...
                        <strong>Website:</strong>{" "}
                        <a href="https://monday.com/lang/de/" target="_blank">
                            https://monday.com/lang/de/
                        </a>
                        ; <strong>Datenschutzerklärung:</strong>{" "}
                        <a
                            href="https://monday.com/l/de/privatsphaere/datenschutzerklarung/"
                            target="_blank"
                        >
                            https://monday.com/l/de/privatsphaere/datenschutzerklarung/
                        </a>
                        ; <strong>Auftragsverarbeitungsvertrag:</strong>{" "}
                        <a href="https://monday.com/l/de/privatsphaere/dpa/" target="_blank">
                            https://monday.com/l/de/privatsphaere/dpa/
                        </a>
                        . <strong>Grundlage Drittlandtransfers:</strong> Standardvertragsklauseln
                        (
                        <a
                            href="https://monday.com/l/de/privatsphaere/standardvertragsbedingungen-fuer-kunden-scc-datenverantwortlicher-zu-datenverarbeiter/"
                            target="_blank"
                        >
                            https://monday.com/l/de/privatsphaere/standardvertragsbedingungen-fuer-kunden-scc-datenverantwortlicher-zu-datenverarbeiter/
                        </a>{" "}
                        (Datenverantwortlicher zu Datenverarbeiter),{" "}
                        <a
                            href="https://monday.com/l/de/privatsphaere/standardvertragsbedingungen-fuer-kunden-scc-datenverarbeiter-zu-datenverarbeiter/"
                            target="_blank"
                        >
                            https://monday.com/l/de/privatsphaere/standardvertragsbedingungen-fuer-kunden-scc-datenverarbeiter-zu-datenverarbeiter/
                        </a>{" "}
                        (Datenverarbeiter zu Datenverarbeiter)).
                    </li>
                </ul>
                ...
                <ul className="glossary">
                    <li>
                        ...
                        ist es erforderlich, dass die Anbieter nachverfolgen können, ob Nutzer,
                    ...
                    <li>
                        ...
                        Zuge der Erstellung, Bearbeitung und Veröffentlichung von Inhalten aller
                        Art generiert werden. Diese Kategorie von Daten kann Texte, Bilder,
                        Videos, Audiodateien und andere multimediale Inhalte einschließen, die auf
                    ...
                    <li>
                        <strong>Künstliche Intelligenz (KI):</strong> Der Zweck der Verarbeitung
                        von Daten durch Künstliche Intelligenz (KI) umfasst die automatisierte
                        Analyse und Verarbeitung von Nutzerdaten, um Muster zu erkennen,
                        Vorhersagen zu treffen und die Effizienz sowie die Qualität unserer
                        Dienstleistungen zu verbessern. Dies beinhaltet die Sammlung, Bereinigung
                        und Strukturierung der Daten, das Training und die Anwendung von
                        KI-Modellen sowie die kontinuierliche Überprüfung und Optimierung der
                    ...
                    <li>
                        ...
                        Informationen, die den Kontext, die Herkunft und die Struktur anderer
                        Daten beschreiben. Sie können Angaben zur Dateigröße, dem
                    ...
                    <li>
                        <strong>Mitgliederdaten:</strong> Mitgliederdaten umfassen Informationen,
                        die sich auf die Individuen beziehen, die Teil einer Organisation, eines
                        Vereins, eines Online-Dienstes oder einer sonstigen Gruppe sind. Diese
                        Daten dienen dazu, Mitgliedschaften zu verwalten, Kommunikation zu
                        ermöglichen und Dienstleistungen oder Vorteile zu erbringen, die mit der
                        Mitgliedschaft verbunden sind. Mitgliederdaten können persönliche
                    ...
                    <li>
                        ...
                        Klickverhalten auf einer Webseite oder den Aufenthaltsort). Zu Zwecken des
                    ...
                    <li>
                        ...
                        z.&nbsp;B. erkennen, zu welcher Zeit Nutzer ihre Webseiten besuchen und
                        für welche Inhalte sie sich interessieren. Dadurch können sie z.&nbsp;B.
                        die Inhalte der Webseiten besser an die Bedürfnisse ihrer Besucher
                    ...
                    <li>
                        ...
                        man, wenn z.&nbsp;B. zu Werbezwecken vermerkt wird, für welche Produkte
                    ...
                    <li>
                        ...
                        Diese Informationen können anschließend z.&nbsp;B. eingesetzt werden, um
                        den Nutzern Werbeanzeigen anzuzeigen, die voraussichtlich deren Interessen
                        entsprechen.{" "}
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        denen Dienstleistungen oder Produkte bereitgestellt, getauscht oder
                        verkauft werden. Diese Datenkategorie ist wesentlich für die Verwaltung
                        und Erfüllung vertraglicher Verpflichtungen und umfasst sowohl die
                    ...
                    <li>
                        ...
                        entscheidender Bedeutung für den elektronischen Handel, das Online-Banking
                        und jede andere Form der finanziellen Transaktion. Sie beinhalten Details
                        wie Kreditkartennummern, Bankverbindungen, Zahlungsbeträge,
                        Transaktionsdaten, Verifizierungsnummern und Rechnungsinformationen.
                        Zahlungsdaten können auch Informationen über den Zahlungsstatus,
                        Rückbuchungen, Autorisierungen und Gebühren enthalten.{" "}
                    </li>
                    <li>
                        <strong>Zielgruppenbildung:</strong> Von Zielgruppenbildung (englisch
                        "Custom Audiences") spricht man, wenn Zielgruppen für Werbezwecke,
                        z.&nbsp;B. Einblendung von Werbeanzeigen bestimmt werden. So kann
                        z.&nbsp;B. anhand des Interesses eines Nutzers an bestimmten Produkten
                        oder Themen im Internet geschlussfolgert werden, dass dieser Nutzer sich
                        für Werbeanzeigen für ähnliche Produkte oder den Onlineshop, in dem er die
