...
export default function CityNameSwitcher() {
    ...
    return (
        <>
            <motion.div className="text-2xl sm:text-3xl md:text-5xl flex flex-row items-center justify-center text-foreground overflow-hidden pt-16 sm:pt-24 px-4"
                initial="hidden"
                whileInView="visible"
                variants={{
            ...
            >
                <LayoutGroup>
                    <motion.div className="flex flex-wrap justify-center text-center md:whitespace-pre" layout>
                        <motion.span
