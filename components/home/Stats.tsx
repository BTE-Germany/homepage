            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="flex items-center flex-col gap-4">
                    <div className="flex flex-row items-end justify-center gap-2">
                        <SlidingNumber number={worldSize} className="text-6xl font-bold" />
                        <p className="font-bold text-2xl text-neutral-400">GB</p>
                    </div>
                    <p className="text-lg text-neutral-400">{t('worldSize')}</p>
                </div>

                <div className="flex items-center flex-col gap-4">
                    <div className="flex flex-row items-end justify-center gap-2">
                        <SlidingNumber number={builders} className="text-6xl font-bold" thousandSeparator="." />

                    </div>
                    <p className="text-lg text-neutral-400">{t('builders')}</p>
                </div>

                <div className="flex items-center flex-col gap-4">
                    <div className="flex flex-row items-end justify-center gap-2">
                        <SlidingNumber number={finishedArea} className="text-6xl font-bold" />
                        <p className="font-bold text-2xl text-neutral-400">km²</p>
                    </div>
                    <p className="text-lg text-neutral-400">{t('totalArea')}</p>
                </div>
            </div>
        </section>
    );
