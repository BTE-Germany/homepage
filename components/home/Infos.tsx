    ...
    return (
        <>
            <div className="my-8 container mx-auto px-4 sm:px-6 md:px-0">
                <motion.div
                    className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-32 items-center"
                ...
                >
                    ...
                    />
                    <div>
                        <p className="text-base sm:text-lg font-bold uppercase text-neutral-400 mb-1">
                            {t("about.heading")}
                        </p>
                ...
                <motion.div
                    className="my-16 sm:my-24 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-32 items-center"
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, ease: [0.03, 0.72, 0.04, 0.98] }}
                    viewport={{ once: true }}
